        ...
        <div className="border-t border-slate-200">
          <div className="flex divide-x divide-slate-200r">
            ...
            <Link
              ...
              to={props.link} //{`/timesheet/${props.id}`}
            >
              <div className="flex items-center justify-center">
                {props.userExists ? (
                  props.userExists(props.data._id) ? (
                    props.linkTitle == "Approve Timesheets" ? (
                      <FontAwesomeIcon icon={faCircle} className="p-2" />
                    ) : null
                  ) : props.linkTitle == "Approve Timesheets" ? (
                    <FontAwesomeIcon icon={faCircleNotch} className="p-2" />
                  ) : null
                ) : null}
