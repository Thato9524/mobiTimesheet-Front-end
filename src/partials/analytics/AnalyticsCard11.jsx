...
//import AnalyticsCardItems from "../../pages/MainPages/AnalyticsPartials/AnalyticsCard11Items";
import AnalyticsCardItems from "../../pages/MainPages/AnalyticsPartials/AnalyticsCard11Items";
...
function AnalyticsCard11(props) {
  ...
  function search(employees) {
    if (props.searchTerm === "") {
      ...
      .some(info => info.project.projectName.toLowerCase().includes(props.searchTerm.toLowerCase()))*/
        ) {
        ...
        if (props.searchTerm === "") {
          ...
          .toLowerCase()
          .includes(props.searchTerm.toLowerCase()) ||*/
          employee.type.toLowerCase().includes(props.searchTerm.toLowerCase())
        ) {
          // console.log("employee: ", employee);
          return employee;
        } else if (
          employee.name.toLowerCase().includes(props.searchTerm.toLowerCase())
        ) {
          // console.log("employee: ", employee);
          return employee;
        }
          ...
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                ...
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-left">Utilization</div>
                </th>
                <th className="p-2 whitespace-nowrap">
            ...
            {/* Table body */}
            {search(props.employeesData).map((employee, index) => {
              return <AnalyticsCardItems key={index} employee={employee} />;
            })}
            {/* {props.employeesData.map((employee) => {
              return <AnalyticsCardItems employee={employee} />;
            })} */}
          </table>
        </div>
      </div>
...
//                       <div className="font-medium text-slate-800">
//                         {/* Projects */}
//                         {employee.projectInfo.map((info) => {
//                           return <div>{info.project.projectName}</div>;
//                         })}
//                       </div>
//                     </div>
//                   </td>
...
//                           return (
//                             <div>
//                               {info.project.businessRep.personalInfo
//                                 .firstName +
//                                 " " +
//                                 info.project.businessRep.personalInfo
//                                   .lastName}
...
//                         {/* Projects */}
//                         {employee.projectInfo.map((info) => {
//                           return <div>{info.totalHours}</div>;
//                         })}
//                       </div>
//                     </div>
//                   </td>
...
//                   <td className="p-2 whitespace-nowrap">
//                     <div className="text-lg text-left">
//                     {employee.utilizationFlag ?(
//                       <div className="inline-flex font-medium rounded-full text-center px-2.5 py-0.5 bg-rose-200 text-rose-500 bg-green-100 text-green-600">
//                         {employee.billableUtilization} {/* billable utilization */}
//                       </div>
//                     ):
