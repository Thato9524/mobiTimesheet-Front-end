...
function Onboarding02() {
  ...
  const handleNext = async () => {
    ...
    // console.log("step2", localStorage.getItem('onboarding'))

    navigateTo("/onboarding-03");
  };

  const Test = async () => {
    // console.log(await localStorage.getItem('onboarding'));
  };
                  ...
                  <div className="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
                    <label className="flex-1 relative block cursor-pointer">
                      <input
                        ...
                        defaultChecked
                      />
                      <div className="h-full text-center bg-white px-4 py-6 rounded border border-zinc-200 hover:border-zinc-300 shadow-sm duration-150 ease-in-out">
                        <svg
                        ...
                        <div className="text-sm">I think I have money</div>
                      </div>
                      <div
                    ...
                    <label className="flex-1 relative block cursor-pointer">
                      ...
                      <div className="h-full text-center bg-white px-4 py-6 rounded border border-zinc-200 hover:border-zinc-300 shadow-sm duration-150 ease-in-out">
                        ...
                        <div className="text-sm">I like the struggle</div>
                      </div>
                      <div
                        className="absolute inset-0 border-2 border-transparent peer-checked:border-rose-400 rounded pointer-events-none"
                        aria-hidden="true"
